...
class DashboardController: UIViewController, ChartViewDelegate, UITableViewDelegate, UITableViewDataSource {
    
    let cellId = "cellId"
    
    weak var axisFormatDelegate: IAxisValueFormatter?
    
    var survey : [SurveyList] = [SurveyList]()
...
//        cht.backgroundColor = .white
    ...
    private func setupFitbitImage(){
        ...
        fitbit.image = image
        fitbit.topAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.topAnchor, constant: -30).isActive = true
    ...
    private func setupBatteryDetails(){
        ...
        batteryImage.topAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.topAnchor, constant: 1).isActive = true
    ...
    func createSurveyArray(){
        survey.append(SurveyList(isExpanded: true, name: "ODI - Low Back Pain", details: [SurveyDetails(myArray: "Survey 1", score: "40%", dateCompleted: "10/01/2018"),
        ...
        survey.append(SurveyList(isExpanded: true, name: "VRS Pain Scale", details: [SurveyDetails(myArray: "Survey 1", score: "48%", dateCompleted: "09/13/2017"),
        ...
        survey.append(SurveyList(isExpanded: true, name: "ODI 3", details: [SurveyDetails(myArray: "Survey 1", score: "40%", dateCompleted: "08/16/2018"),
                                                                        SurveyDetails(myArray: "Survey 2", score: "50%", dateCompleted: "09/15/2018"),
                                                                        SurveyDetails(myArray: "Survey 3", score: "70%", dateCompleted: "10/10/2018")]))
        
        numbers.append(Steps(date:Date(dashboardDate: "2018-01-01")!,count: 4312))
        numbers.append(Steps(date:Date(dashboardDate: "2018-02-01")!,count: 3105))
        numbers.append(Steps(date:Date(dashboardDate: "2018-03-01")!,count:114))
        numbers.append(Steps(date:Date(dashboardDate: "2018-04-01")!,count:3716))
        numbers.append(Steps(date:Date(dashboardDate: "2018-05-01")!,count:3230))
        numbers.append(Steps(date:Date(dashboardDate: "2018-06-01")!,count:785))
        numbers.append(Steps(date:Date(dashboardDate: "2018-07-01")!,count:1830))
        numbers.append(Steps(date:Date(dashboardDate: "2018-08-01")!,count:2915))
        numbers.append(Steps(date:Date(dashboardDate: "2018-09-01")!,count:3011))
        numbers.append(Steps(date:Date(dashboardDate: "2018-10-01")!,count:104))
        numbers.append(Steps(date:Date(dashboardDate: "2018-11-01")!,count:2056))
    }
}
...
extension Date {
    ...
    init?(dashboardDate: String) {
        let dateStringFormatter = DateFormatter()
        dateStringFormatter.dateFormat = "yyyy-MM-dd"
        if let d = dateStringFormatter.date(from: dashboardDate) {
